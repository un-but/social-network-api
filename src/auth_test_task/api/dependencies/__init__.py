...
from auth_test_task.api.dependencies.access import find_rule_info
from auth_test_task.api.dependencies.auth import auth_dep, optional_auth_dep
from auth_test_task.api.dependencies.objects import comment_dep, post_dep, role_rule_dep, user_dep
