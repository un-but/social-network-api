...
Данные всех настройках можно найти в файле src/social_network_api/schemas/_configuration.py.
"""
...
from social_network_api.api.routers import auth, comment, post, role_rule, users
